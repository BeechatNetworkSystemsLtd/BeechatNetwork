...
public class DataReceiveListener implements IDataReceiveListener {
    ...
    /**
     * A data listener. Use this on a DigiMesh Device to listen for incoming data
     * within range.
     * 
        ...
        try {
            ...
            if (messages.size() > 0) {
                ...
                if (pubkeyfooterIndex != 0 && pubkeyheaderIndex != 0) {
                    ...
                    if (tempcontact[0][0] != null && tempcontact[1][0] != null && tempcontact[2][0] != null) {
                ...
                if (AESSignal) {
                    if (temppubkey != null) {
                        try {
                            ...
                            String cleanpubkey = tempcontact[3][0];// .substring(temppubkey.indexOf("-----BEGIN PUBLIC
                                                                   // KEY-----"));
                            ...
                            Process pubkeymake = Runtime.getRuntime()
                                    .exec(new String[] { "bash", "-c",
                                            "echo '" + cleanpubkey + "' > " + configfilesLocation.toString()
                        ...
                        try {
                            new GetSharedSecret("", configfilesLocation + "/myprivatekey.pem",
                                    configfilesLocation + "/contactpublickey.pem");
                    ...
                    if (messages.get(linecounter).contains("CHAT END")) {
                        ...
                        try {
                            ...
                            try (FileOutputStream stream = new FileOutputStream(configfilesLocation + "/msg.bin")) {
                        ...
                        try {
                            ...
                            System.out.println(encmessage.getAbsolutePath().substring(0,
                                    encmessage.getAbsolutePath().lastIndexOf(".bin")));
                        ...
                        /*
                         * apend message to log file Process appendtologfile =
                         * Runtime.getRuntime().exec(new String[]{ "bash", "-c", "echo '" +
                         * xbeeMessage.getDevice().getNodeID() + ": " +
                         * file2string(downloadfilesLocation + "/msg") + "' >> " + configfilesLocation +
                         * "/" + xbeeMessage.getDevice().getNodeID()}); appendtologfile.waitFor(); TODO:
                         * maybe there is a better way to append to logfiles?
                         * 
                         */
            ...
            // try {
            // new AddContact(tempcontact[0][0], tempcontact[1][0], tempcontact[2][0],
            // tempcontact[3][0]);
            // } catch (IOException e) {
