...
public class MainApp {
	...
	public static void main(String[] args) throws Throwable {		
		...
		Path[] allfolders = new Path[8];
		
		allfolders[0]= generatorsLocation;
		allfolders[1]= privatekeysLocation ;
		allfolders[2]= publickeysLocation ;
		allfolders[3]= configfilesLocation ;
		allfolders[4]= downloadfilesLocation ;
		allfolders[5]= uploadfilesLocation ;
		allfolders[6]= deepspeechLocation ;
		allfolders[7]= deepspeechModelsLocation ;
